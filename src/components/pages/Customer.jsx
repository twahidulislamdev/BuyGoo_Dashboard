...
const EditModal = ({ customer, onClose, onSave }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setSaving(true);
    axios
      .post("http://localhost:3000/api/v1/customer/edituser", {
        email: form.email,
...
const AddModal = ({ onClose, onAdd }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setSaving(true);
    axios
      .post("http://localhost:3000/api/v1/customer/addnewuser", {
        firstName: form.firstName,
        lastName: form.lastName,
        email: form.email,
...
const CustomerList = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3000/api/v1/customer/getallusers")
      .then((res) => {
  ...
  const handleDelete = (id) => {
    ...
    if (!customer) return;
    axios
      .post("http://localhost:3000/api/v1/customer/deleteuser", {
        email: customer.email,
      })
      .then(() => {
  ...
  const handleDeleteSelected = () => {
    axios
      .post("http://localhost:3000/api/v1/customer/deleteallusers", {
        emails: customers
