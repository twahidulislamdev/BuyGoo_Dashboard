...
const EditModal = ({ customer, onClose, onSave }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setSaving(true);
    axios
      .post("https://buygoo-backend.onrender.com/api/v1/auth/edituser", {
        email: form.email,
...
const AddModal = ({ onClose, onAdd }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setSaving(true);
    axios
      .post("https://buygoo-backend.onrender.com/api/v1/auth/addnewuser", {
        firstName: form.firstName,
        lastName: form.lastName,
        email: form.email,
...
const CustomerList = () => {
  ...
  useEffect(() => {
    axios
      .get("https://buygoo-backend.onrender.com/api/v1/auth/getallusers")
      .then((res) => {
  ...
  const handleDelete = (id) => {
    ...
    if (!customer) return;
    axios
      .post("https://buygoo-backend.onrender.com/api/v1/auth/deleteuser", {
        email: customer.email,
      })
      .then(() => {
  ...
  const handleDeleteSelected = () => {
    axios
      .post("https://buygoo-backend.onrender.com/api/v1/auth/deleteallusers", {
        emails: customers
