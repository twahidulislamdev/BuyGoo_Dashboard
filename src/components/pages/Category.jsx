...
const CategoryModalForm = ({ onCancel, onSuccess }) => {
  ...
  const handleCreateCategory = async () => {
    try {
      await axios.post(
        "https://buygoo-backend.onrender.com/api/v1/category/createcategory",
        {
          name: categoryName,
          slug: categorySlug,
...
const UpdateCategoryModalForm = ({ onCancel, onSuccess, category }) => {
  ...
  const handleUpdateCategory = async () => {
    try {
      await axios.put(
        `https://buygoo-backend.onrender.com/api/v1/category/updatecategory/${category._id}`,
        {
          name: formData.name,
          slug: formData.slug,
...
const Category = () => {
  ...
  const deleteCategory = async (id) => {
    try {
      await axios.delete(
        `https://buygoo-backend.onrender.com/api/v1/category/deletecategory/${id}`,
      );
  ...
  const deleteAllCategory = async () => {
    try {
      await axios.delete(
        `https://buygoo-backend.onrender.com/api/v1/category/deleteallcategory`,
      );
